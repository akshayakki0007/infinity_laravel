...
class FaqController extends Controller
{
    ...
    {       
        ...
        $this->ModuleTitle = 'FAQ';
        $this->ModuleView  = 'Backend/Faq.';
        $this->ModulePath  = 'admin/faq';
    }
    ...
    public function store(Request $request)
    {
        ...
        if($arrModel->save()) 
        {
            ...
            $this->JsonData['msg']      = 'Faq added successfully.';
        }
        else
        {
            DB::rollBack();
            $this->JsonData['status']   = 'error';
            $this->JsonData['msg']      = 'Failed to faq add, Something went wrong.';
        }
    ...
    public function edit($id)
    {
        ...
        $this->ViewData['modulePath']   = $this->ModulePath;
        $this->ViewData['object']       = FaqModel::find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($arrModel->save())
        {
            ...
            $this->JsonData['msg']      = 'Faq details updated successfully';
        }
        else
        {
            $this->JsonData['status'] = 'error';
    ...
    public function destroy($id)
    {
        ...
        {
            $this->JsonData['status'] = 'success';
            $this->JsonData['msg']    = 'Faq deleted successfully.';
        }
        else
        {
            $this->JsonData['status'] = 'error';
