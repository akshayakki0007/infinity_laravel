...
class EmailTemplateController extends Controller
{
    ...
    {       
        ...
        $this->ModuleTitle = 'Email Templates';
        $this->ModuleView  = 'Backend/Email_template.';
        $this->ModulePath  = 'admin/email_templates';
    }
    ...
    {
        //dd($this->emailServices->send_email_to_admin('Admin contact us email','1','contactus'));
        //dd($this->emailServices->send_email('Lead mail','10','test@gmail.com','purchase'));
        //dd($this->emailServices->send_email('Lead mail','6',''));
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'subject.required'     => 'Name field is required.',
            'description.required' => 'Description field is required.',
        ]);

        $arrModel              = new EmailTemplateModel();
        $arrModel->name        = $request->name;
        $arrModel->subject     = $request->subject;
        ...
        if($arrModel->save()) 
        {
            ...
            $this->JsonData['msg']      = 'Email Template added successfully.';
        }
        else
        {
            DB::rollBack();
            $this->JsonData['status']   = 'error';
            $this->JsonData['msg']      = 'Failed to add, Something went wrong.';
        }
    ...
    public function edit($id)
    {
        ...
        $this->ViewData['modulePath']   = $this->ModulePath;
        $this->ViewData['object']       = EmailTemplateModel::find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $arrModel              = EmailTemplateModel::find($id);
        $arrModel->name        = $request->name;
        $arrModel->subject     = $request->subject;
        $arrModel->description = $request->description;
        ...
        if($arrModel->save())
        {
            ...
            $this->JsonData['msg']      = 'Email Template details updated successfully';
        }
        else
        {
            $this->JsonData['status'] = 'error';
    ...
    public function destroy($id)
    {
        ...
        {
            $this->JsonData['status'] = 'success';
            $this->JsonData['msg']    = 'Email Template deleted successfully.';
        }
        else
        {
            $this->JsonData['status'] = 'error';
    ...
    {
        $arrBaseModel = EmailTemplateModel::find($id);
