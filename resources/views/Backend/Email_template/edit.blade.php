			      	...
			      	<div class="box-body">
			      		<div class="col-md-12">
						   	...
						   	<div class="form-group">
						      	...
						      	<input type="text" class="form-control" id="subject" name="subject" placeholder="Enter subject" value="{{ $object->subject }}">
						   	</div>
						   	<div class="form-group">
						   	...
						   	<div class="form-group">
						      	<label for="description">User Prefix</label>
						   		<p style="font-weight: 700;"><?php echo '{{ip_address}}'; ?> , <?php echo '{{reportId}}'; ?> , <?php echo '{{reportTitle}}'; ?> , <?php echo '{{publisher}}'; ?> ,  <?php echo '{{job_title}}'; ?> , <?php echo '{{date}}'; ?> , <?php echo '{{customer_name}}'; ?> , <?php echo '{{customer_email}}'; ?> , <?php echo '{{customer_contact_no}}'; ?> , <?php echo '{{company_name}}'; ?> , <?php echo '{{sales_person_name}}'; ?> , <?php echo '{{site_url}}'; ?> , <?php echo '{{request_type}}'; ?> , <?php echo '{{message}}'; ?> </p>
						   	</div>
						</div>
					</div>
