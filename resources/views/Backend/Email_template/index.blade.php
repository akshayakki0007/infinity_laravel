...
@section('scripts')
	<script type="text/javascript">
		$(document).ready(function() 
		{
		    ...
		    var targetURL = adminPath+'/email_templates/getData'; 
		...
		function actionDelete(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/email_templates/destroy/'+id;
		...
		function actionUpdateStatus(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/email_templates/updateStatus/'+id;
