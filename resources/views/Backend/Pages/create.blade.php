			      	...
			      	<div class="box-body">
			      		<div class="col-md-12">
						   	...
						   	<div class="form-group">
						      	...
						      	<input type="text" class="form-control" id="meta_tite" name="meta_tite" placeholder="Enter meta tite">
						   	</div>
						   	<div class="form-group">
						      	<label for="meta_keyword">Meta keyword</label>
						      	<input type="text" class="form-control" id="meta_keyword" name="meta_keyword" placeholder="Enter meta keyword">
						   	</div>
						   	<div class="form-group">
						      	<label for="meta_descriptions">Meta description</label>
						      	<textarea class="form-control" id="meta_descriptions" name="meta_descriptions" rows="5" placeholder="Enter meta description"></textarea>
						   	</div>
						</div>
					</div>
