			      	...
			      	<div class="box-body">
			      		<div class="col-md-12">
						   	...
						   	<div class="form-group">
						      	...
						      	<input type="text" class="form-control" id="designation" name="designation" placeholder="Enter designation" value="{{ $object->designation }}">
						   	</div>
						   	<div class="form-group">
                                <label for="review_type_generic">Type</label><br>
                                <label class="radio-inline" for="review_type_generic">
                                  	<input type="radio" name="review_type" id="review_type_generic" value="generic" @if($object->type == 'generic') checked @endif >&nbsp;Generic report
                                </label>
                                <label class="radio-inline" for="review_type_specific">
                                  	<input type="radio" name="review_type" id="review_type_specific" value="specific" @if($object->type == 'specific') checked @endif >&nbsp;Specific report
                                </label>
                            </div>
						   	<div class="form-group">
						      	<label for="description">Description</label>
						      	<textarea class="form-control" id="description" name="description" placeholder="Enter a description">{{ $object->description }}</textarea>
						   	</div>
						</div>
					</div>
