...
@section('scripts')
	<script type="text/javascript">
		$(document).ready(function() 
		{
		    ...
		    var targetURL = adminPath+'/reviews/getData'; 
		    ...
		    {        
		        ...
		        columns: [
		            ...
		            { "data": "designation",  "orderseble": "true"},
		            { "data": "type",         "orderseble": "true"},
		...
		function actionDelete(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/reviews/destroy/'+id;
		...
		function actionUpdateStatus(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/reviews/updateStatus/'+id;
