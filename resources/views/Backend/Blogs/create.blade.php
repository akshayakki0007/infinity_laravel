			      	...
			      	<div class="box-body">
			      		<div class="col-md-12">
						   	...
						   	<div class="form-group">
						      	...
						      	<textarea class="form-control" name="short_description" id="short_description" rows="5" placeholder="Enter short category"></textarea>
						   	</div>
						   	...
						   	<div class="form-group">
						      	...
						      	<input type="text" class="form-control datepicker" id="publish_date" name="publish_date" placeholder="Enter publish date" autocomplete="off">
						   	</div>
						</div>
					</div>
