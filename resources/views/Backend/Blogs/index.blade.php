...
@section('scripts')
	<script type="text/javascript">
		$(document).ready(function() 
		{
		    ...
		    var targetURL = adminPath+'/blogs/getData'; 
		    ...
		    {        
		        ...
		        columns: [
		            ...
		            { "data": "title",        "orderseble": "true"},
		            { "data": "fk_category",  "orderseble": "true"},
		            { "data": "author",       "orderseble": "true"},
		...
		function actionDelete(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/blogs/destroy/'+id;
		...
		function actionUpdateStatus(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/blogs/updateStatus/'+id;
