...
@section('scripts')
	<script type="text/javascript">
		$(document).ready(function() 
		{
		    ...
		    var targetURL = adminPath+'/publisher/getData'; 
		    ...
		    {        
		        ...
		        columns: [
		            ...
		            { "data": "nick_name",    "orderseble": "true"},
		...
		function actionDelete(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/publisher/destroy/'+id;
		...
		function actionUpdateStatus(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/publisher/updateStatus/'+id;
