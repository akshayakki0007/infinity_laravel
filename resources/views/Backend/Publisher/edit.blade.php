			   	...
			   	<form onsubmit="return actionSave(this)" action="{{url($modulePath.'/update', [ $object->id ])}}"  method="put" enctype="multipart/form-data">
			      	...
			      	<div class="box-body">
			      		<div class="col-md-12">
						   	...
						   	<div class="form-group">
						      	<label for="nick_name">Nice name</label>
						      	<input type="text" class="form-control" id="nick_name" name="nick_name" placeholder="Enter nick name" maxlength="3" value="{{ $object->nick_name }}">
						   	</div>
						</div>
					</div>
