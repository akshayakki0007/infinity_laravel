...
@section('scripts')
	<script type="text/javascript">
		$(document).ready(function() 
		{
		    ...
		    var targetURL = adminPath+'/users/getData'; 
		    ...
		    {        
		        ...
		        columns: [
		            ...
		            { "data": "email",        "orderseble": "true"},
		            { "data": "role",         "orderseble": "true"},
		...
		function actionDelete(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/users/destroy/'+id;
		...
		function actionUpdateStatus(element)
		{
		    ...
		    var adminPath = $('meta[name="admin-path"]').attr('content');
		    var targetURL = adminPath+'/users/updateStatus/'+id;
