			      	...
			      	<div class="box-body">
			      		<div class="col-md-12">
						   	<div class="form-group">
						      	...
						      	<input type="text" class="form-control" id="report_title" name="report_title" placeholder="Enter report title">
						   	</div>
						   	<div class="form-group">
						      	<label for="slug">Slug</label>
						      	<input type="text" class="form-control" id="slug" name="slug" placeholder="Enter report title">
						   	</div>
						   	<div class="form-group">
						   	...
						   	<div class="form-group">
								   ...
								   <div class="col-md-4">
								      	...
								      	<input type="text" class="form-control float-number" name="single_user_price" id="single_user_price" placeholder="Enter Single user price">
								   </div>
								   <div class="col-md-4">
								   		<label for="multi_user_price">Multi user price ($)</label>
								      	<input type="text" class="form-control float-number" name="multi_user_price" id="multi_user_price" placeholder="Enter Multi user price">
								   </div>
								   <div class="col-md-4">
								   		<label for="pages">Pages</label>
								      	<input type="text" class="form-control float-number" name="pages" id="pages" placeholder="Enter Multi user price">
								   </div>
								</div>
							</div>
						   	<div class="form-group">
						   	...
						   	<div class="form-group">
						      	...
						      	<textarea class="form-control" id="toc" name="toc" rows="5" placeholder="Enter table of contents"></textarea>
						   	</div>
						</div>
					</div>
